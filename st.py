...
####2: Debemos extraer las tablas de datos de nuestra hoja EXCEL 'mapudungun.xlsx'
...
####3: Ahora debemos crear diccionarios para poder acceder a cada una de las combinaciones, en este caso tomaremos la columna
####'persona' como índice
...
#####5: Estableciendo FONDO DE LA APP:
